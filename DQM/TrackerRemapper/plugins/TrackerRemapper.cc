...
{
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIB_L1] = stripBaseDir + "TIB/layer_1/" + stripDesiredHistogram + "_TIB_L1;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIB_L2] = stripBaseDir + "TIB/layer_2/" + stripDesiredHistogram + "_TIB_L2;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIB_L3] = stripBaseDir + "TIB/layer_3/" + stripDesiredHistogram + "_TIB_L3;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIB_L4] = stripBaseDir + "TIB/layer_4/" + stripDesiredHistogram + "_TIB_L4;1";

  stripHistnameMap[TkLayerMap::TkLayerEnum::TIDM_D1] = stripBaseDir + "TID/MINUS/wheel_1/" + stripDesiredHistogram + "_TIDM_D1;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIDM_D2] = stripBaseDir + "TID/MINUS/wheel_2/" + stripDesiredHistogram + "_TIDM_D2;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIDM_D3] = stripBaseDir + "TID/MINUS/wheel_3/" + stripDesiredHistogram + "_TIDM_D3;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIDP_D1] = stripBaseDir + "TID/PLUS/wheel_1/" + stripDesiredHistogram + "_TIDP_D1;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIDP_D2] = stripBaseDir + "TID/PLUS/wheel_2/" + stripDesiredHistogram + "_TIDP_D2;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TIDP_D3] = stripBaseDir + "TID/PLUS/wheel_3/" + stripDesiredHistogram + "_TIDP_D3;1";

  stripHistnameMap[TkLayerMap::TkLayerEnum::TOB_L1] = stripBaseDir + "TOB/layer_1/" + stripDesiredHistogram + "_TOB_L1;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TOB_L2] = stripBaseDir + "TOB/layer_2/" + stripDesiredHistogram + "_TOB_L2;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TOB_L3] = stripBaseDir + "TOB/layer_3/" + stripDesiredHistogram + "_TOB_L3;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TOB_L4] = stripBaseDir + "TOB/layer_4/" + stripDesiredHistogram + "_TOB_L4;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TOB_L5] = stripBaseDir + "TOB/layer_5/" + stripDesiredHistogram + "_TOB_L5;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TOB_L6] = stripBaseDir + "TOB/layer_6/" + stripDesiredHistogram + "_TOB_L6;1";

  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W1] = stripBaseDir + "TEC/MINUS/wheel_1/" + stripDesiredHistogram + "_TECM_W1;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W2] = stripBaseDir + "TEC/MINUS/wheel_2/" + stripDesiredHistogram + "_TECM_W2;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W3] = stripBaseDir + "TEC/MINUS/wheel_3/" + stripDesiredHistogram + "_TECM_W3;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W4] = stripBaseDir + "TEC/MINUS/wheel_4/" + stripDesiredHistogram + "_TECM_W4;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W5] = stripBaseDir + "TEC/MINUS/wheel_5/" + stripDesiredHistogram + "_TECM_W5;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W6] = stripBaseDir + "TEC/MINUS/wheel_6/" + stripDesiredHistogram + "_TECM_W6;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W7] = stripBaseDir + "TEC/MINUS/wheel_7/" + stripDesiredHistogram + "_TECM_W7;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W8] = stripBaseDir + "TEC/MINUS/wheel_8/" + stripDesiredHistogram + "_TECM_W8;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECM_W9] = stripBaseDir + "TEC/MINUS/wheel_9/" + stripDesiredHistogram + "_TECM_W9;1";

  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W1] = stripBaseDir + "TEC/PLUS/wheel_1/" + stripDesiredHistogram + "_TECP_W1;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W2] = stripBaseDir + "TEC/PLUS/wheel_2/" + stripDesiredHistogram + "_TECP_W2;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W3] = stripBaseDir + "TEC/PLUS/wheel_3/" + stripDesiredHistogram + "_TECP_W3;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W4] = stripBaseDir + "TEC/PLUS/wheel_4/" + stripDesiredHistogram + "_TECP_W4;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W5] = stripBaseDir + "TEC/PLUS/wheel_5/" + stripDesiredHistogram + "_TECP_W5;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W6] = stripBaseDir + "TEC/PLUS/wheel_6/" + stripDesiredHistogram + "_TECP_W6;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W7] = stripBaseDir + "TEC/PLUS/wheel_7/" + stripDesiredHistogram + "_TECP_W7;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W8] = stripBaseDir + "TEC/PLUS/wheel_8/" + stripDesiredHistogram + "_TECP_W8;1";
  stripHistnameMap[TkLayerMap::TkLayerEnum::TECP_W9] = stripBaseDir + "TEC/PLUS/wheel_9/" + stripDesiredHistogram + "_TECP_W9;1";
...
void TrackerRemapper::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  tkdetmap = edm::Service<TkDetMap>().operator->();

  if (!trackerMap) BookBins(theTrackerGeometry, tt);
...
void TrackerRemapper::ReadVertices(double& minx, double& maxx,
                                   double& miny, double& maxy)
{
  std::ifstream in;

	in.open(edm::FileInPath("DQM/TrackerRemapper/src/tkmap_bare").fullPath().c_str());
...
void TrackerRemapper::FillStripRemap()
{
  ...
  {
    tkdetmap->getComponents(layer, nchX, lowX, highX,
                                   nchY, lowY, highY);
...
void TrackerRemapper::FillBarrelRemap(TFile* rootFileHandle, ESHandle < TrackerGeometry >& theTrackerGeometry, const TrackerTopology* tt)
{
  ...
  for (auto &i: pxb)
  {
    ...
    if (signedOnlineModule <= 0) --signedOnlineModule;
...
void TrackerRemapper::FillEndcapRemap(TFile* rootFileHandle, ESHandle < TrackerGeometry >& theTrackerGeometry, const TrackerTopology* tt)
{
